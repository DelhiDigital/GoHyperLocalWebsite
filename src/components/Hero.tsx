      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl sm:text-2xl font-medium mb-4 text-white/90">
              Logistics Intelligence for{" "}
              <em className="text-cyan not-italic font-semibold">
                D2C Quick Commerce
              </em>
            </p>
            ...
            <div className="flex items-center gap-6 mb-8">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                ...
                <span className="text-sm font-medium">4.8 on G2</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                ...
                <span className="text-sm font-medium">4.4 on Capterra</span>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/60">
                    Repeat purchase rate on D2C Q-commerce
                  </div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/60">
                    Shoppers want delivery in &lt;3 hours
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 transform rotate-1">
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    {/* Map placeholder */}
                    <div className="bg-gradient-to-br from-blue/10 to-cyan/10 rounded-lg h-40 flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4 w-6 h-6 bg-cyan rounded-full flex items-center justify-center shadow z-10">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          height: "2px",
                          background:
                            "linear-gradient(90deg, #155FFF, #0EE2E2)",
                        }}
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-gray-50 rounded-lg p-3 text-center">
                      <div className="text-lg font-bold text-navy">12 min</div>
                      <div className="text-xs text-gray-500">ETA</div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-3 text-center">
                      <div className="text-lg font-bold text-navy">2.4 km</div>
